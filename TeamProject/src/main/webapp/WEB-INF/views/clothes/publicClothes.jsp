	...
	<div class="col-md-2"></div>
		<div class="col-md-8">
			...
			<div>
				<ul class="nowMenu">
					<li><a href="/">홈 </a>></li>
					<li><a style="color:red;" href="/clothes/publicClothes">남녀공용</a></li>
				</ul>
			</div>
			...
			<div class="row listMain">
				...
				<div class="col-md-8 productList">
					...
					<ul class="nav nav-pills list" style="display:none;">
						<li class="nav-item"><a class="nav-link" href="#"><img style="width:225px; height:225px;" src="/resources/image/socks.jpg"/></a></li>
						<li class="nav-item" style="width:360px;"><a class="nav-link productName" href="#">코튼 구찌 양말<br></a><span id="price">199,900</span>원<br> 무료배송</li>
